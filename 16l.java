...
//1. Цикл for (1)
//В цикле for вы используете массив Number, который содержит элементы разных типов: Integer, int, Float и Double. Когда вы перебираете этот массив и передаете элементы в метод printNum, происходит следующее:
